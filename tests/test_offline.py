...
def main() -> int:
    ...
    check(
        # Portal encodes 0/1 as status codes for every tyre-pressure family (#14).
        # Real pressures are scaled (e.g. 24 = 2.4 bar), so raw 1 is invalid, not 1 bar.
        "required tyre pressure 1 = invalid sentinel (#14)",
